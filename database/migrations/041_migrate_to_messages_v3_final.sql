-- Migration: Final migration to messages_v3 table structure
-- This migration creates the exact messages_v3 table structure as requested
-- and migrates data from messages_v2 to the new JSON-based structure

-- Step 1: Create the messages_v3 table with the exact structure provided
...
-- Step 6: Create helper functions for working with JSON messages
