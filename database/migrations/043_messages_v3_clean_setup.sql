-- Clean messages_v3 setup - add missing indexes, RLS policies, and functions
...
CREATE INDEX IF NOT EXISTS messages_v3_conversation_id_idx 
  ON public.messages_v3 USING btree (conversation_id);

CREATE INDEX IF NOT EXISTS messages_v3_last_message_at_idx 
  ON public.messages_v3 USING btree (last_message_at DESC);

CREATE INDEX IF NOT EXISTS messages_v3_messages_gin_idx 
  ON public.messages_v3 USING gin (messages);
